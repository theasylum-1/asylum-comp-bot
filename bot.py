    ...
    content = [
        {
            ...
            "text": (
                ...
                "Look for a plastic slab with a label at the top or bottom. Grading companies: PSA, BGS (Beckett), SGC, CGC.\n"
                "If graded, READ THE LABEL CAREFULLY — it contains the most accurate card info:\n"
                "- Grading company (PSA, BGS, SGC, CGC)\n"
                "- Grade (e.g. GEM MT 10, MINT 9, NM-MT 8, 9.5)\n"
                "- Card description (year, brand, set, player, variation, card number)\n"
                "- Cert/barcode number\n\n"
                ...
                "- 'grade': The numeric or letter grade (e.g. '10', '9.5', '9', 'Auth'). Empty if not graded.\n\n"
